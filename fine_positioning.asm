...
; Finally we'll do a WSYNC followed by HMOVE to apply the fine offset.
	...
	sta HMOVE	; apply offset
        ; with this commented out, the offset is never applied, so only
        ; increments of 15 get applied
...
NUMBERS ;;{w:8,h:6,count:10,brev:1};;
	.byte $EE,$AA,$AA,$AA,$EE,$00 ;;sprite for 0
        .byte $22,$22,$22,$22,$22,$00 ; 1
        .byte $EE,$22,$EE,$88,$EE,$00 ; 2
        .byte $EE,$22,$66,$22,$EE,$00 ; 3
        .byte $AA,$AA,$EE,$22,$22,$00 ; 4
        .byte $EE,$88,$EE,$22,$EE,$00 ; 5
        .byte $EE,$88,$EE,$AA,$EE,$00 ; 6
        .byte $EE,$22,$22,$22,$22,$00 ; 7
        .byte $EE,$AA,$EE,$AA,$EE,$00 ; 8 
        .byte $EE,$AA,$EE,$22,$EE,$00 ; 9
